...
import { buyLink, chartsLink } from '../../utils'
		...
		<section className="flex py-14 smm:py-20 md:py-28 text-center flex-col">
			<div className="px-6 ssm:px-10 max-w-[1066px] mx-auto w-full flex justify-between flex-col">
				...
				<div className="pt-5 smm:pt-9 md:pt-[55px] mx-auto flex gap-5 items-center text-sm ssm:text-base md:text-xl">
					<a href={buyLink} target="_blank" rel="noopener noreferrer" className="fancy-left-hero-btn py-3 px-6 md:px-8 md:py-4 rounded-full gap-3 flex items-center hover:scale-105">Buy Here <CgArrowRight /></a>
					<a href={chartsLink} target="_blank" rel="noopener noreferrer" className="fancy-right-hero-btn py-3 px-6 md:px-8 md:py-4 rounded-full gap-3 flex items-center hover:scale-105">Charts <CgArrowRight /></a>
				</div>
			</div>
