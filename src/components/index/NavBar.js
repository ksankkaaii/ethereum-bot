...
const NavBar = () => {
	...
	return (
		<section className="flex px-6 ssm:px-10" id="home">
			<nav className="max-w-[1350px] mx-auto w-full py-7 flex justify-between">
				<img src="/images/logo.png" alt="Logo" className="w-14 h-14" />
				<ul className="hidden md:flex gap-8 lg:gap-14 xl:gap-[70px] items-center font-clash">
				...
				<div className="hidden md:flex items-center justify-center gap-3 flex-wrap">
					<Link to="/dashboard" className="bg-white bg-opacity-20 w-8 h-8 xl:w-10 xl:h-10 flex items-center justify-center rounded-full hover:scale-105"><MdSpaceDashboard className="w-4 h-4 xl:w-5 xl:h-5" /></Link>
					<a href={twitterLink} target="_blank" rel="noopener noreferrer" className="bg-white bg-opacity-20 w-8 h-8 xl:w-10 xl:h-10 flex items-center justify-center rounded-full hover:scale-105"><FaTwitter className="w-4 h-4 xl:w-5 xl:h-5" /></a>
					<a href={mLink} target="_blank" rel="noopener noreferrer" className="bg-white bg-opacity-20 w-8 h-8 xl:w-10 xl:h-10 flex items-center justify-center rounded-full hover:scale-105"><img className="w-4 h-4 xl:w-5 xl:h-5" src="/images/fa-mmm.svg" alt="M" /></a>
					<a href={discordLink} target="_blank" rel="noopener noreferrer" className="bg-white bg-opacity-20 w-8 h-8 xl:w-10 xl:h-10 flex items-center justify-center rounded-full hover:scale-105"><FaDiscord className="w-4 h-4 xl:w-5 xl:h-5" /></a>
					<a href={teelgramLink} target="_blank" rel="noopener noreferrer" className="bg-white bg-opacity-20 w-8 h-8 xl:w-10 xl:h-10 flex items-center justify-center rounded-full hover:scale-105"><FaTelegram className="w-4 h-4 xl:w-5 xl:h-5" /></a>
				</div>
